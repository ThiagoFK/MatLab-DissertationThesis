...
t0=[1.13e-3 1.12e-3 1.12e-3];
w0=[12.70e-3 12.68e-3 12.70e-3];
Lu=50e-3;

TensileTestData1 = importdata('Ensaio1_4512_12_Teste_00_01\12T0001.mad');
TensileTestData2 = importdata('Ensaio1_4512_12_Teste_00_02\12T0002.mad');
TensileTestData3 = importdata('Ensaio1_4512_12_Teste_00_03\12T0003.mad');
LankfordData1 = readmatrix('Ensaio1_4512_12_Teste_00_01\12T0001.csv');
LankfordData2 = readmatrix('Ensaio1_4512_12_Teste_00_02\12T0002.csv');
LankfordData3 = readmatrix('Ensaio1_4512_12_Teste_00_03\12T0003.csv');
...
% plot(exp(LankfordData1(:,8))-1,LankfordData1(:,1)-28)
% hold on
% plot(Strain1,Deformation1/(2.54/60))
